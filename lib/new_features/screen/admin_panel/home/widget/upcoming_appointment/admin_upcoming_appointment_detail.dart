...
class AdminUpcomingAppointmentDetail extends StatefulWidget {
  const AdminUpcomingAppointmentDetail({super.key, required this.ds});

  final DocumentSnapshot<Object?> ds;

  @override
  State<AdminUpcomingAppointmentDetail> createState() =>
      _AdminUpcomingAppointmentDetailState();
}

class _AdminUpcomingAppointmentDetailState
    extends State<AdminUpcomingAppointmentDetail> {
  @override
