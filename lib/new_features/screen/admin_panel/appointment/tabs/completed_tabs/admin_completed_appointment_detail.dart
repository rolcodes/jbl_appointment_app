...
class AdminCompletedAppointmentDetail extends StatefulWidget {
  const AdminCompletedAppointmentDetail({super.key, required this.ds});

  final DocumentSnapshot<Object?> ds;

  @override
  State<AdminCompletedAppointmentDetail> createState() => _AdminCompletedAppointmentDetailState();
}

class _AdminCompletedAppointmentDetailState extends State<AdminCompletedAppointmentDetail> {
  @override
