...
class AdminRequestAppointmentDetail extends StatefulWidget {
  const AdminRequestAppointmentDetail({super.key, required this.ds});

  final DocumentSnapshot<Object?> ds;

  @override
  State<AdminRequestAppointmentDetail> createState() =>
      _AdminRequestAppointmentDetailState();
}

class _AdminRequestAppointmentDetailState
    extends State<AdminRequestAppointmentDetail> {
  @override
