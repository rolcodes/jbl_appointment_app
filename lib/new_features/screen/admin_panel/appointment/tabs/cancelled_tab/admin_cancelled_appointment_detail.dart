...
class AdminCancelledAppointmentDetail extends StatefulWidget {
  const AdminCancelledAppointmentDetail({super.key, required this.ds});

  final DocumentSnapshot<Object?> ds;

  @override
  State<AdminCancelledAppointmentDetail> createState() => _AdminCancelledAppointmentDetailState();
}

class _AdminCancelledAppointmentDetailState extends State<AdminCancelledAppointmentDetail> {
  @override
